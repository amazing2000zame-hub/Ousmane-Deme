...
Plans:
- [ ] 30-01-PLAN.md -- Frontend + backend acknowledgment fixes (dedicated event, immediate playback, Piper preference)
- [ ] 30-02-PLAN.md -- Tool timeout and error handling improvements (60s timeout, graceful failures)
