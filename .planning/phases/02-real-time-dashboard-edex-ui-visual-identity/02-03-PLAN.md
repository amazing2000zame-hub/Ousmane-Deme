...
must_haves:
  ...
  artifacts:
    - path: "jarvis-ui/src/components/layout/Dashboard.tsx"
      provides: "3-column CSS grid layout"
      min_lines: 30
...
<task type="auto">
  ...
  **components/layout/Dashboard.tsx:**
  ...
  - Left column: infrastructure panels (NodeGrid, VMList, StoragePanel)
  - Center column: multi-purpose display (placeholder div for now with text "JARVIS DISPLAY")
  - Right column: terminal panel (placeholder div for now with text "TERMINAL")
  ...
  **components/shared/StalenessWarning.tsx:**
  ...
  <done>
  Dashboard has a 3-column grid layout. TopBar shows quorum status, connection indicator, and mode switcher. PanelFrame provides consistent panel chrome. Shared components (StatusDot, UsageBar, StalenessWarning) are ready for use across all panels.
  </done>
</task>
