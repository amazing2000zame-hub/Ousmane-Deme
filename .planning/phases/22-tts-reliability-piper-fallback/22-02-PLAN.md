...
Note: CachedAudio interface is defined around line 235. The `CachedAudioWithEngine` type reference will work because TypeScript hoists interfaces. Alternatively, place `CachedAudioWithEngine` right after the `CachedAudio` interface if cleaner.
